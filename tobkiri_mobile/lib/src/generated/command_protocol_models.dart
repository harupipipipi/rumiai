...
final class CommandInvocationRequest {
  ...
  JsonMap toJson() => <String, Object?>{
    ...
    if (authorityApprovalToken != null) "authority_approval_token": authorityApprovalToken,
  };
}
final class CommandProtocolError {
  const CommandProtocolError({
    required this.code,
...
final class CommandInvocationResult {
  ...
  factory CommandInvocationResult.fromJson(JsonMap json) => CommandInvocationResult(
    apiVersion: json["api_version"] as String? ?? '',
    operationId: json["operation_id"] as String? ?? '',
    status: json["status"] as String? ?? '',
    commandRef: json["command_ref"] as String? ?? '',
    stateChanges: (json["state_changes"] as List<Object?>? ?? const []).whereType<JsonMap>().toList(growable: false),
    error: json["error"] is JsonMap ? CommandProtocolError.fromJson(json["error"] as JsonMap) : null,
  );
}
