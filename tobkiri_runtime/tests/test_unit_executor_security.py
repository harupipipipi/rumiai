...
_P_APPROVAL = "tobkiri_runtime.core_runtime.approval_manager.get_approval_manager"
_P_STORE_REG = "tobkiri_runtime.core_runtime.store_registry.get_store_registry"
_P_UNIT_REG = "tobkiri_runtime.core_runtime.unit_registry.get_unit_registry"
_P_UNIT_REF_CLS = "tobkiri_runtime.core_runtime.unit_registry.UnitRef"
_P_GRANT = (
    "tobkiri_runtime.core_runtime.capability_grant_manager"
    ".get_capability_grant_manager"
)
_P_TRUST = "tobkiri_runtime.core_runtime.unit_trust_store.get_unit_trust_store"
_P_AUDIT = "tobkiri_runtime.core_runtime.audit_logger.get_audit_logger"
_P_PLATFORM = "tobkiri_runtime.core_runtime.unit_executor.platform.system"
...
def _make_executor():
    from tobkiri_runtime.core_runtime.unit_executor import UnitExecutor
    return UnitExecutor()
...
class TestKindWhitelist(unittest.TestCase):
    ...
    def test_allowed_kinds_constant(self):
        from tobkiri_runtime.core_runtime.unit_executor import ALLOWED_KINDS
...
class TestTOCTOUMitigation(unittest.TestCase):
    ...
    def test_verified_content_forwarded(self):
        ...
        try:
            ...
            def spy(um, args, timeout, start, vc=None):
                ...
                from tobkiri_runtime.core_runtime.unit_executor import (
                    UnitExecutionResult,
                )
    ...
    def test_temp_files_cleaned_up(self):
        ...
        try:
            ...
            with patch(
                "tobkiri_runtime.core_runtime.unit_executor.tempfile.mkstemp",
                side_effect=tracking,
            ), patch(
                "tobkiri_runtime.core_runtime.unit_executor.subprocess.run",
            ) as mock_run:
...
class TestSetuidSetgidCheck(unittest.TestCase):
    ...
    def test_setuid_rejected(self, _):
        ...
        try:
            with patch(
                "tobkiri_runtime.core_runtime.unit_executor.os.stat",
