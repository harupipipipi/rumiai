...
Run with:
    RUMI_RUN_WINDOWS_NATIVE_TESTS=1 pytest tobkiri_runtime/tests/test_windows_native_computerseat.py
"""
...
from tobkiri_runtime.ecosystem.rumi_default_tools_pack.domain.computer.drivers.windows_postmessage import (
    WindowsPostMessageDriver,
)
from tobkiri_runtime.ecosystem.rumi_default_tools_pack.domain.computer.drivers.windows_uia import (
    WindowsUIADriver,
)
from tobkiri_runtime.ecosystem.rumi_default_tools_pack.domain.computer.models import ComputerTarget
from tobkiri_runtime.ecosystem.rumi_default_tools_pack.domain.computer.windows.hwnd import (
    get_window_info,
    list_windows,
)
from tobkiri_runtime.ecosystem.rumi_default_tools_pack.domain.computer.windows.integrity import (
