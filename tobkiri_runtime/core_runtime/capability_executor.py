...
_crypto_utils = (
    sys.modules.get("tobkiri_runtime.core_runtime.crypto_utils")
    or sys.modules.get("core_runtime.crypto_utils")
    or _loaded_crypto_utils
)
sys.modules["core_runtime.crypto_utils"] = _crypto_utils
sys.modules["tobkiri_runtime.core_runtime.crypto_utils"] = _crypto_utils
...
def _secure_tmp_state_module():
    ...
    for module_name in (
        ...
        "tobkiri_runtime.core_runtime.capability_executor",
    ):
