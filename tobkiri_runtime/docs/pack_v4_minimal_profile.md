...
Defaults Profile remains a separate later integration fixture. Replacing the
conformance backend with a real Wasm/PackVM supervisor is a subsequent step and
does not change the Profile/Contract/Request/Authority interfaces proven here.
