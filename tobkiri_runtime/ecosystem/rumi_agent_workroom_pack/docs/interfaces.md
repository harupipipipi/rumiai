...
- `rumi_operations_company_pack`: Owns adjacent agent-service choreography and cross-worker PR/status orchestration after the workroom emits approved handoff packets.
