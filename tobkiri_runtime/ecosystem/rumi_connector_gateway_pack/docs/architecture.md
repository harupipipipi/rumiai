...
3. Handoff envelopes normalize work requests before local-agent presets, workspace artifacts, defaultspack scheduler flows, or approval review consume them.
