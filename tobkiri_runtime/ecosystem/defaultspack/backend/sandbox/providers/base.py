...
class GuestAgentClient(Protocol):
    ...
    def read_file(self, sandbox_id: str, payload: dict[str, object]) -> dict[str, object]: ...
    def apply_file_patch(self, sandbox_id: str, payload: dict[str, object]) -> dict[str, object]: ...
    def expose_port(self, sandbox_id: str, payload: dict[str, object]) -> dict[str, object]: ...
