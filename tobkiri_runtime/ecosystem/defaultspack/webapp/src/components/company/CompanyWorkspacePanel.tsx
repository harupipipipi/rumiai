...
export function CompanyWorkspacePanel({
  ...
  return (
    ...
    >
      ...
      {error && (
        <div role="alert" aria-atomic="true" className="m-2 flex items-start gap-2 rounded-md border border-amber-500/20 bg-amber-500/10 px-2 py-1.5 text-[11px] text-amber-200">
