...
- schema_contracts_only
    ...
    Existing defaultspack artifact stores, chat artifact serving, share links, tool execution, and MCP execution are never overridden. This pack can select/read existing records and draft package contracts, then hands execution back to the owner pack.
