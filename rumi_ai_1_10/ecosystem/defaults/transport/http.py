    ...
    def _setup_routes(self):
        ...
        *path_inject* is a dict mapping URL param names to request_data keys
        ...
        fallback = [
            ...
            ("POST", "/api/packs/defaults/knowledge/search", self._handle_knowledge_search),
            ("GET", "/api/packs/defaults/knowledge/{id}", self._handle_knowledge_get),
            ("PUT", "/api/packs/defaults/knowledge/{id}", self._handle_knowledge_update),
            ("DELETE", "/api/packs/defaults/knowledge/{id}", self._handle_knowledge_delete),
            # ---- Prompt routes ----
