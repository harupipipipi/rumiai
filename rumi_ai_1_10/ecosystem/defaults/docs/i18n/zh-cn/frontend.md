...
|----------|--------|------|
| §鲁米§0§|单身|水平排列 |
| §鲁米§0§|堆栈|垂直堆叠，每个Asset都可以调整大小 |
| §鲁米§0§|堆栈|垂直堆叠 |
| §鲁米§0§|标签 |您还可以切换和拆分选项卡 |
| §鲁米§0§|标签 |标签切换 |
| §鲁米§0§|单身|水平排列 |
| §鲁米§0§|浮动|必要时叠加显示|
...
|------|------|---------------|
| §鲁米§0§|文字|文字|
| §鲁米§0§|代码|语言、内容、文件名、line_start |
| §鲁米§0§|差异|旧内容、新内容、文件名 |
| §鲁米§0§|图片| src、alt、宽度、高度 |
| §鲁米§0§|截图|来源、网址、标题 |
| §鲁米§0§|进展|标签、当前、总计、状态 |
| §鲁米§0§|终端输出|命令、输出、退出代码 |
| §鲁米§0§|表|标题、行|
| §鲁米§0§|图|图表类型、数据、标签 |
| §鲁米§0§|文件树|树|
| §鲁米§0§|降价|内容 |
