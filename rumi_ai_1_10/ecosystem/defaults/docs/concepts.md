...
- **`domain/agent/multi.py`** — `MultiAgentOrchestrator`: Multi-agent orchestration.
...
- **`domain/prompt/template.py`** — `PromptTemplate`: Unified template system for tools and prompts.
