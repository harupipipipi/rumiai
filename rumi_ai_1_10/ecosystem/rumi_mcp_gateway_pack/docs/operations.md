...
```bash
python -m pytest rumi_ai_1_10/tests/test_rumi_mcp_gateway_pack_contract.py
```

Useful nearby checks:

```bash
python -m pytest rumi_ai_1_10/tests/test_setup_pack_selector.py rumi_ai_1_10/tests/test_defaultspack_mcp_registry.py
```
