...
class PcConversationBackend implements ConversationBackend {
  ...
  Stream<ChatEvent> sendMessage({
    ...
    final requestParams = <String, dynamic>{if (params != null) ...params};
      ...
      switch (type) {
        ...
        case 'approval_requested':
          ...
          return ApprovalEvent(
            ...
            enforcementMetadata:
                (json['enforcement_metadata'] as Map?)?.map(
                  (key, value) => MapEntry('$key', value),
                ) ??
                (data['enforcement_metadata'] as Map?)?.map(
                  (key, value) => MapEntry('$key', value),
                ),
          );
