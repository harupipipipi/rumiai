# ecosystem/default/backend/components/tool/tool_loader.py
"""
...
class ToolLoader:
    def __init__(self, tools_dir: Path = None):
        ...
        if tools_dir is None:
            # エコシステム経由でパス解決を試みる
            try:
                from backend_core.ecosystem.compat import get_tools_assets_dir, is_ecosystem_initialized
                if is_ecosystem_initialized():
                    tools_dir = get_tools_assets_dir()
                else:
