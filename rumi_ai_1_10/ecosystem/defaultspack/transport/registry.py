...
_FALLBACK_HTTP_ROUTE_SPECS = [
    ...
    HttpRouteSpec("GET", "/api/agent/company/manifest", block_module="blocks.agent.company.manifest"),
    HttpRouteSpec("GET", "/api/agent/company/status", block_module="blocks.agent.company.status"),
    HttpRouteSpec("POST", "/api/agent/company/bootstrap", block_module="blocks.agent.company.bootstrap"),
    HttpRouteSpec("GET", "/api/agents", block_module="blocks.agent.agents.list"),
    HttpRouteSpec("POST", "/api/agents", block_module="blocks.agent.agents.create"),
    HttpRouteSpec("GET", "/api/agents/{id}", block_module="blocks.agent.agents.get", path_inject={"id": "agent_id"}),
    HttpRouteSpec("PUT", "/api/agents/{id}", block_module="blocks.agent.agents.update", path_inject={"id": "agent_id"}),
    HttpRouteSpec("DELETE", "/api/agents/{id}", block_module="blocks.agent.agents.delete", path_inject={"id": "agent_id"}),
    HttpRouteSpec("POST", "/api/agents/{id}/start", block_module="blocks.agent.agents.start", path_inject={"id": "agent_id"}),
    HttpRouteSpec("POST", "/api/agents/{id}/pause", block_module="blocks.agent.agents.pause", path_inject={"id": "agent_id"}),
    HttpRouteSpec("POST", "/api/agents/{id}/resume", block_module="blocks.agent.agents.resume", path_inject={"id": "agent_id"}),
    ...
    HttpRouteSpec("GET", "/api/browser/profiles", block_module="blocks.browser.profiles"),
    HttpRouteSpec("POST", "/api/browser/profiles", block_module="blocks.browser.profiles"),
    HttpRouteSpec("GET", "/api/browser/profiles/{id}", block_module="blocks.browser.profile", path_inject={"id": "profile_id"}),
    HttpRouteSpec("PUT", "/api/browser/profiles/{id}", block_module="blocks.browser.profile", path_inject={"id": "profile_id"}),
    HttpRouteSpec("DELETE", "/api/browser/profiles/{id}", block_module="blocks.browser.profile", path_inject={"id": "profile_id"}),
    HttpRouteSpec("POST", "/api/browser/profiles/{id}/start", block_module="blocks.browser.start", path_inject={"id": "profile_id"}),
    HttpRouteSpec("POST", "/api/browser/profiles/{id}/stop", block_module="blocks.browser.stop", path_inject={"id": "profile_id"}),
    HttpRouteSpec("POST", "/api/browser/profiles/{id}/restart", block_module="blocks.browser.restart", path_inject={"id": "profile_id"}),
    HttpRouteSpec("GET", "/api/browser/profiles/{id}/health", block_module="blocks.browser.health", path_inject={"id": "profile_id"}),
    HttpRouteSpec("POST", "/api/browser/profiles/{id}/active", block_module="blocks.browser.active", path_inject={"id": "profile_id"}),
    HttpRouteSpec("POST", "/api/browser/profiles/{id}/actions", block_module="blocks.browser.actions", path_inject={"id": "profile_id"}),
    HttpRouteSpec("GET", "/api/browser/profiles/{id}/tabs", block_module="blocks.browser.tabs", path_inject={"id": "profile_id"}),
    HttpRouteSpec("POST", "/api/browser/profiles/{id}/tabs", block_module="blocks.browser.tabs", path_inject={"id": "profile_id"}),
    HttpRouteSpec("POST", "/api/browser/profiles/{id}/tabs/{tab_id}/focus", block_module="blocks.browser.tab_focus", path_inject={"id": "profile_id", "tab_id": "tab_id"}),
    HttpRouteSpec("DELETE", "/api/browser/profiles/{id}/tabs/{tab_id}", block_module="blocks.browser.tab_close", path_inject={"id": "profile_id", "tab_id": "tab_id"}),
    HttpRouteSpec("POST", "/api/browser/profiles/{id}/snapshot", block_module="blocks.browser.snapshot", path_inject={"id": "profile_id"}),
    HttpRouteSpec("POST", "/api/browser/profiles/{id}/screenshot", block_module="blocks.browser.screenshot", path_inject={"id": "profile_id"}),
    HttpRouteSpec("GET", "/api/approvals", block_module="blocks.approval.list"),
    HttpRouteSpec("GET", "/api/approvals/policy", block_module="blocks.approval.policy"),
    HttpRouteSpec("PUT", "/api/approvals/policy", block_module="blocks.approval.policy"),
    HttpRouteSpec("GET", "/api/approvals/{id}", block_module="blocks.approval.get", path_inject={"id": "approval_id"}),
    HttpRouteSpec("POST", "/api/approvals/{id}/approve", block_module="blocks.approval.approve", path_inject={"id": "approval_id"}),
    HttpRouteSpec("POST", "/api/approvals/{id}/deny", block_module="blocks.approval.deny", path_inject={"id": "approval_id"}),
    HttpRouteSpec("POST", "/api/approvals/{id}/decision", block_module="blocks.approval.decision", path_inject={"id": "approval_id"}),
    HttpRouteSpec("POST", "/api/approvals/{id}/approve_once", block_module="blocks.approval.approve_once", path_inject={"id": "approval_id"}),
    HttpRouteSpec("POST", "/api/approvals/{id}/approve_for_session", block_module="blocks.approval.approve_for_session", path_inject={"id": "approval_id"}),
    ...
    HttpRouteSpec("GET", "/api/ai/keys", block_module="blocks.ai_keys.list"),
    HttpRouteSpec("POST", "/api/ai/keys", block_module="blocks.ai_keys.create"),
    HttpRouteSpec("GET", "/api/ai/keys/{id}", block_module="blocks.ai_keys.get", path_inject={"id": "key_id"}),
    HttpRouteSpec("PUT", "/api/ai/keys/{id}", block_module="blocks.ai_keys.update", path_inject={"id": "key_id"}),
    HttpRouteSpec("DELETE", "/api/ai/keys/{id}", block_module="blocks.ai_keys.delete", path_inject={"id": "key_id"}),
    HttpRouteSpec("POST", "/api/ai/keys/{id}/test", block_module="blocks.ai_keys.test", path_inject={"id": "key_id"}),
    HttpRouteSpec("GET", "/api/ai/keys/{id}/usage", block_module="blocks.ai_keys.usage", path_inject={"id": "key_id"}),
