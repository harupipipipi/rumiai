...
| 방법 | 경로 | 핸들러(블록) |
|---|---|---|
| `POST` | `/v1/chat/completions` | `defaultspack.chat_turn`(`blocks/chat/send.py` 대체) |
...
| `POST` | `/api/chat/conversations/{id}/messages` | `defaultspack.chat_turn`(`blocks/chat/send.py` 대체) |
| `POST` | `/api/chat/conversations/{id}/stream` | `defaultspack.chat_stream_turn`(`blocks/chat/stream.py` 대체) |
