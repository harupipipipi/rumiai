...
`AudiencePolicy`, `InputProfile` 선택, `submit_input` 호출 후 반환 또는
...
| 방법 | 경로 | 역할 |
|---|---|---|
| §루미§0§ | §루미§1§ | 비밀 상태만 있고 원시 값은 없습니다 |
| §루미§0§ | §루미§1§ | 지원되는 공급자 비밀에 대한 쓰기 전용 설정 또는 지우기 |
| §루미§0§ | §루미§1§ | Slack 이벤트 접수 |
| §루미§0§ | §루미§1§ | LINE 웹훅 유입 |
| §루미§0§ | §루미§1§ | Discord 상호작용 섭취 |
| §루미§0§ | §루미§1§ | 디스코드 이벤트 접수 |
| §루미§0§ | §루미§1§ | 마스크된 외부 토큰 상태 |
| §루미§0§ | §루미§1§ | 쓰기 전용 외부 토큰 upsert, 이름 바꾸기, 삭제 |
| §루미§0§ | §루미§1§ | 일반 웹훅 섭취 |
| §루미§0§ | §루미§1§ | 웹훅 엔드포인트 구성 나열 |
| §루미§0§ | §루미§1§ | 웹훅 엔드포인트 구성 생성 |
| §루미§0§ | §루미§1§ | 웹훅 엔드포인트 구성 업데이트 |
| §루미§0§ | §루미§1§ | 웹훅 엔드포인트 구성 삭제 |
| §루미§0§ | §루미§1§ | 웹훅 테스트 페이로드 실행 |
| §루미§0§ | §루미§1§ | 공용 URL 공급자 및 로컬 기본 URL 나열 |
| §루미§0§ | §루미§1§ | 공급자 지원 공개 URL을 생성합니다. 실패 시 수정된 `ok: false` 데이터 반환 |
| §루미§0§ | §루미§1§ | 공개 URL을 닫거나 지우기 |
...
| 외부 입력.md | 제공자 중립적 섭취 경로 정의: `ExternalEvent`, `AudiencePolicy`, `InputProfile`, `submit_input`, `ResponsePlanner` 및 `ResponseAdapter` |
| webhooks.md | 표준화된 제출 전 웹후크별 확인 및 확인 동작을 문서화합니다. |
