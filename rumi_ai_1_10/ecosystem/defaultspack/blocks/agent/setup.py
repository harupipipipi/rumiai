...
def run(context):
    ...
    routes = [
        ...
        # ---- Create Agent / Agent Factory routes ----
        ("GET", "/api/agents", _lazy("blocks.agent.agents.list"), {}),
        ("POST", "/api/agents", _lazy("blocks.agent.agents.create"), {}),
        ("GET", "/api/agents/{id}", _lazy("blocks.agent.agents.get"), {"id": "agent_id"}),
        ("PUT", "/api/agents/{id}", _lazy("blocks.agent.agents.update"), {"id": "agent_id"}),
        ("DELETE", "/api/agents/{id}", _lazy("blocks.agent.agents.delete"), {"id": "agent_id"}),
        ("POST", "/api/agents/{id}/start", _lazy("blocks.agent.agents.start"), {"id": "agent_id"}),
        ("POST", "/api/agents/{id}/pause", _lazy("blocks.agent.agents.pause"), {"id": "agent_id"}),
        ("POST", "/api/agents/{id}/resume", _lazy("blocks.agent.agents.resume"), {"id": "agent_id"}),
