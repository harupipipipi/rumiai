...
export function CompanyTree({
  ...
  activeTaskCount,
  busy = false,
  emptyMessage = "No workroom loaded.",
  onSelect,
  onBootstrap,
  onRefresh,
}: {
    ...
    <section className="border-b border-zinc-800/60 p-2">
      <div className="mb-2 flex items-center justify-between gap-2">
        <div className="flex min-w-0 items-center gap-2">
          ...
          <h3 className="truncate text-[12px] font-semibold text-zinc-200">Workroom</h3>
        </div>
          ...
          return (
            ...
            >
              ...
              <span className="mt-0.5 flex items-center gap-2 text-[10px] text-zinc-500">
                <span>{company.agent_count ?? Object.keys(company.agents ?? {}).length} members</span>
