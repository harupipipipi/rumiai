...
function ChatApp() {
  ...
  const refreshHealth = useCallback(async (reason: "bootstrap" | "poll" | "focus" = "poll") => {
    try {
      ...
      void api.dashboardHealth().then(setDashboardHealth).catch(() => setDashboardHealth(null));
