...
AGENT_FUNCTIONS: tuple[FunctionSpec, ...] = tuple(
    ...
    for function_id, description, risk, block in (
        ...
        ("agent_multi_execute", "Start a multi-agent execution.", "medium", "blocks.agent.multi_execute"),
        ("agent_multi_status", "Get multi-agent status.", "low", "blocks.agent.multi_status"),
        ("agent_multi_message", "Send a multi-agent message.", "medium", "blocks.agent.multi_message"),
