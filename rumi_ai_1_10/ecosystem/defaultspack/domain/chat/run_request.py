...
def prepare_chat_run(
    ...
    authority_resume_followup = _hidden_authority_followup_from_metadata(metadata) is not None
...
def _runtime_profile_with_policy_connected_tools(
    ...
    *,
    ...
    if base_profile and snapshot_profile_id and base_profile_id and base_profile_id != snapshot_profile_id:
