...
包括`bundled/uv`、`bundled/pack-shell`。 `.venv`，`node_modules`，
...
**日期和时间**：2026-03-28 19:17 UTC**结果**：手动取消（共4个作业，成功前取消）**原因**：三个独立问题同时发生
...
**日期和时间**：2026-03-28 20:15 UTC**结果**：4个工作中，2个失败，2个预计成功，但最终被消灭。
...
**日期和时间**：2026-03-28 22:21 UTC**结果**：所有 4 项工作均成功
