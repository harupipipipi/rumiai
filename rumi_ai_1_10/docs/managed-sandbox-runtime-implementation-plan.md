...
`rumi_ai_1_10/ecosystem/defaultspack/backend/sandbox/sandbox_manager.py`
...
`rumi_ai_1_10/ecosystem/defaultspack/domain/tool/sandbox_tools.py`
...
`rumi_ai_1_10/ecosystem/rumi_sandbox_runtime_pack/`
...
```text
rumi_ai_1_10/ecosystem/defaultspack/backend/sandbox/
├── __init__.py
├── loader.py
├── models.py
├── errors.py
...
```text
rumi_ai_1_10/ecosystem/defaultspack/runtime_agent/
├── __init__.py
├── __main__.py
├── server.py
├── auth.py
...
```text
rumi_ai_1_10/ecosystem/rumi_sandbox_runtime_pack/templates/
...
```text
rumi_ai_1_10/ecosystem/defaultspack/webapp/src/features/sandboxes/
├── api.ts
├── types.ts
├── runtimeStatus.ts
├── useRuntimeDoctor.ts
...
rumi_ai_1_10/ecosystem/defaultspack/webapp/src/components/desktops/
...
```bash
python -m pytest rumi_ai_1_10/tests/test_defaultspack_sandbox_manager.py -q
python -m pytest rumi_ai_1_10/tests/test_managed_runtime_*.py -q
