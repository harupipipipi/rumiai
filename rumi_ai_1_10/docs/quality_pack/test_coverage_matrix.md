...
| frontend/UI | `tests/test_frontend_ux_contract_matrix_contract.py`, `frontend_ux_contract_matrix.yaml`, `frontend lint/build` 実行 | 主要画面の状態遷移・DOM契約・導線・ビルド破綻の回帰検知 |
