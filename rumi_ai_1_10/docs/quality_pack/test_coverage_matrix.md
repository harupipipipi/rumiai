...
| contract | `tests/test_entrypoint_contracts.py`, `tests/test_claude_quality_pack_contract.py`, `tests/test_quality_debug_playbook_contract.py` | README/CI/entrypoint/デバッグ手順契約の破壊を検知 |
