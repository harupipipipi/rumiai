...
「何をしたいか」から、最短で読む場所に辿るための入口です。ここには runtime 共通 docs と Pack 共通ルールだけを置き、Pack 固有の本体説明は各 `ecosystem/<pack_id>/docs/` に寄せます。
...
| defaultspack の実装側を追いたい | [../ecosystem/defaultspack/docs/README.md](../ecosystem/defaultspack/docs/README.md) | [../ecosystem/defaultspack/README.md](../ecosystem/defaultspack/README.md) |
...
| [defaultspack_v2.md](./defaultspack_v2.md) | [../ecosystem/defaultspack/docs/README.md](../ecosystem/defaultspack/docs/README.md) |
