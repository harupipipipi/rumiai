...
def _isolate_chat_model_catalog(monkeypatch, tmp_path):
    ...
    monkeypatch.setenv(
        ...
        str(user_data / "shared" / "chat" / "conversations.json"),
    )
    monkeypatch.setattr(
    ...
    monkeypatch.setattr(
        ...
        lambda *args, **kwargs: {"status": "ok", "model": "stub/default", "output": {}},
    )
