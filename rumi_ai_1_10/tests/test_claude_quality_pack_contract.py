...
def test_quality_pack_docs_exist_and_have_required_sections():
    ...
    longrun_migration_matrix = (
        PACKAGE_ROOT / "docs" / "quality_pack" / "longrun_migration_contract_matrix.yaml"
    )
    ...
    runtime_boundary_matrix = (
        PACKAGE_ROOT / "docs" / "quality_pack" / "runtime_boundary_contract_matrix.yaml"
    )
...
def test_coverage_matrix_references_existing_tests():
    ...
    expected_paths = [
        ...
        "tests/test_runtime_boundary_contract_matrix_contract.py",
