...
def test_missing_design_intent_and_non_token_color_fail_validation(tmp_path: Path) -> None:
    ...
    bad_state["options"]["fakeFailures"] = {"reply-composer/candidate-1": "missing-state", "reply-composer/candidate-2": "missing-state"}
    bad_color = build_args("non-token-run")
    bad_color["options"]["fakeFailures"] = {"reply-composer/candidate-1": "non-token-color", "reply-composer/candidate-2": "non-token-color"}
