...
try:
    ...
    try:
        from prompt.prompt_dependency_manager import PromptDependencyManager
    except ImportError:
...
class PromptLoader:
    ...
    def __init__(self, prompt_dir: Path = None):
        ...
        if prompt_dir is None:
            # エコシステム経由でパス解決を試みる
            try:
                from backend_core.ecosystem.compat import get_prompts_dir, is_ecosystem_initialized
