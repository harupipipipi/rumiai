...
const en: Dict = {
  ...
  'settings.rumi_account': 'Rumi Account',
  'settings.rumi_account_desc': 'Connect with your Rumi account.',
  'settings.connect': 'Connect',
  'settings.reconnect': 'Reconnect',
  'settings.connected': 'Connected',
  'settings.not_connected': 'Not connected',
  'settings.login_required': 'Please connect your Rumi account to edit your profile.',
  ...
  'settings.updates_desc': 'Separate update lifecycles for Viewer, Core, and Packs.',
  'settings.viewer_update': 'Viewer',
  'settings.viewer_update_desc': 'Desktop shell updates.',
  'settings.core_update': 'Core',
  'settings.core_update_desc': 'Python runtime updates.',
  'settings.pack_updates': 'Packs',
  'settings.pack_updates_desc': 'Managed user-data pack updates.',
  'settings.check_updates': 'Check',
  'settings.update_available': 'Available',
  'settings.up_to_date': 'Current',
  'settings.apply_update': 'Update',
  'settings.rollback_update': 'Rollback',
...
const ja: Dict = {
  ...
  'settings.updates_desc': 'Viewer\u3001Core\u3001Pack \u3092\u5225\u3005\u306e\u30e9\u30a4\u30d5\u30b5\u30a4\u30af\u30eb\u3067\u66f4\u65b0\u3057\u307e\u3059\u3002',
  'settings.viewer_update': 'Viewer',
  'settings.viewer_update_desc': '\u30c7\u30b9\u30af\u30c8\u30c3\u30d7\u30b7\u30a7\u30eb\u306e\u66f4\u65b0\u3002',
  'settings.core_update': 'Core',
  'settings.core_update_desc': 'Python runtime \u306e\u66f4\u65b0\u3002',
  'settings.pack_updates': 'Packs',
  'settings.pack_updates_desc': '\u30e6\u30fc\u30b6\u30fc\u30c7\u30fc\u30bf\u3067\u7ba1\u7406\u3055\u308c\u308b Pack \u306e\u66f4\u65b0\u3002',
  'settings.check_updates': '\u78ba\u8a8d',
  'settings.update_available': '\u5229\u7528\u53ef',
  'settings.up_to_date': '\u6700\u65b0',
  'settings.apply_update': '\u66f4\u65b0',
  'settings.rollback_update': '\u30ed\u30fc\u30eb\u30d0\u30c3\u30af',
